...
pub const __CUDA_API_VERSION: u32 = 7000;
pub const CUDA_VERSION: u32 = 7000;
...
pub const CUdevice_attribute_enum_CU_DEVICE_ATTRIBUTE_MAX: CUdevice_attribute_enum = 86;
...
pub const CUjit_option_enum_CU_JIT_NUM_OPTIONS: CUjit_option_enum = 15;
