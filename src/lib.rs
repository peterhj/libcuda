/*!
# Cargo features for CUDA versions
...
- `fresh`: For developers or maintainers of the cuda crate itself. This feature
  generates a fresh set of FFI bindings using bindgen from the build script.
