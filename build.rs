...
fn main() {
  ...
  if let Some(ref cuda_include_dir) = maybe_cuda_include_dir {
    ...
    .whitelist_function("cublasAxpyEx")
    .whitelist_function("cublasDotEx")
    .whitelist_function("cublasNrm2Ex")
    .whitelist_function("cublasScalEx")
  ...
  if cfg!(feature = "cuda_gte_8_0") {
    ...
    if let Some(ref cuda_include_dir) = maybe_cuda_include_dir {
      ...
      .whitelist_function("cublasHgemmBatched")
      .whitelist_function("cublasHgemmStridedBatched")
      .generate_comments(false)
      .rustfmt_bindings(true)
      .generate()
